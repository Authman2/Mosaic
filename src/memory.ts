...
const NODE_TYPE: String = "node";
const ATTRIBUTE_TYPE: String = "attribute";
...
export class Memory {
    ...
    * @param {Any} value The value to set on this Memory. */
    commit(mosaic: Mosaic, value: any) {
        ...
        let element = mosaic.element as HTMLElement;
        let child = element;
        ...
        switch(this.type) {
            case NODE_TYPE: this.commitNode(mosaic, child, value); break;
            case ATTRIBUTE_TYPE: this.commitAttribute(mosaic, child, value); break;
            case EVENT_TYPE: this.commitEvent(mosaic, child, value); break;
            default:
    ...
    */
    ...
    commitAttribute(mosaic: Mosaic, child: HTMLElement, value: any) {
    ...
    commitEvent(mosaic: Mosaic, child: HTMLElement | ChildNode, value: any) {
        let name = (this.attribute as MemoryAttribute).attributeName;
